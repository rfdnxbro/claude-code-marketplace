...
- claude.ai ログインと Console（API key）認証のいずれでも動作する
...
# 複数チャンネルを同時に有効化する場合
claude --channels plugin:telegram-channel@my-marketplace plugin:discord-bot@my-marketplace
...
以下は公式ドキュメントに記載が見当たらず、本ドキュメントでも保証しません:
